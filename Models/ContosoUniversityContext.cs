...
namespace webapi01.Models
{
    public partial class ContosoUniversityContext : DbContext
    {
        ...
        public virtual DbSet<Department02> Department02 { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=sysycloud.ddns.net;Database=ContosoUniversity;User ID=sa;Password=!abcd1234");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Department02>(entity =>
            {
                entity.HasNoKey();
